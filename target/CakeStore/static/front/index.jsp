...
<body>
	...
	<div class="banner">
		<div class="container">
			<h2 class="hdng">Happy <span>Cakes</span></h2>
			<p>每日新烤好味道，做令你最开心的蛋糕</p>
			<a href="products.jsp">立即选购</a>
			<div class="banner-text">			
				<img src="${pageContext.request.contextPath}/static/front/images/2.png" alt=""/>
			</div>
		</div>
	</div>			
	<!--//banner-->
		...
		<div class="container">
			<div class="gallery-grids">
				<div class="col-md-8 gallery-grid glry-one">
					<a href="products.jsp"><img src="${pageContext.request.contextPath}/static/front/images/g1.jpg" class="img-responsive" alt=""/>
						<div class="gallery-info">
							<p><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> view</p>
							<a class="shop" href="${pageContext.request.contextPath}/front/product/single">立即购买</a>
				...
				<div class="col-md-4 gallery-grid glry-two">
					<a href="${pageContext.request.contextPath}/front/product/products"><img src="${pageContext.request.contextPath}/static/front/images/g2.jpg" class="img-responsive" alt=""/>
